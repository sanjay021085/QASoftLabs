        ...
        {services.map((f, i) => {
          ...
          return (
            <motion.div
              ...
              className="card-hover group relative rounded-3xl border border-emerald-100 bg-white p-7 hover:shadow-[0_28px_70px_-24px_rgba(16,185,129,0.4)] hover:border-emerald-300 overflow-hidden"
            >
